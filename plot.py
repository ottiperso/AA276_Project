...
def plot_brt_only(values_converged_interpolator):
    ...
    BUG 1 FIX: slice in delta_pz vs delta_vz (the dynamically relevant plane)
    since control only acts on delta_vz. The old px vs pz slice showed a
    meaningless ellipse because neither axis had control authority.
